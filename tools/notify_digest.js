...
// ─────────────────────────────────────────────────────────────────────────────
// ⚠️ 功能开关 · 2026-09-12 用户要求「删除 Server酱 推送通知功能」，此处已关闭。
//    行为：只打印一行提示后正常退出（exit 0），不读取数据、不发送、不报错。
//    下方原始实现【完整保留】。日后若要恢复微信推送：删掉下面这两行即可。
// ─────────────────────────────────────────────────────────────────────────────
console.log('[notify_digest] 微信推送通知功能已于 2026-09-12 下线，本次跳过发送。');
process.exit(0);
